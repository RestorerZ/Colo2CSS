...
function BrightColo(colo, corr, ld)
    let l:hexcolo = ''
    let l:colo = a:colo
    let l:corr = str2float(a:corr)
    echo 'acorr ' a:corr
    if '#' == l:colo[0:0]
"	let l:colo = trim(l:colo, '#', 1)
	let l:colo = a:colo[1:]
    endif
"    let l:r = str2nr(l:colo[0:1], 16)
"    let l:g = str2nr(l:colo[2:3], 16)
"    let l:b = str2nr(l:colo[4:5], 16)
"    if 0 > a:corr
"	let l:corr = -(a:corr)
"	echo 1 + a:corr
...
"	echo 'neg corr b ' l:b
"    else
"	let l:r = (255-l:r) * a:corr + l:r
"	echo 'pos corr r ' l:r
"	let l:g = (255-l:g) * a:corr + l:g
"	echo 'pos corr g ' l:g
"	let l:b = (255-l:b) * a:corr + l:b
"	echo 'pos corr b ' l:b
"    endif
"    let l:r = s:Dec2Hex(l:r)
"    let l:g = s:Dec2Hex(l:g)
"    let l:b = s:Dec2Hex(l:b)
"    return l:r..l:g..l:b
...
"let l:chcc = 0
let l:idx = 0
while len(l:colo) > l:idx
    let l:cc = str2nr(l:colo[l:idx:l:idx+1], 16)
    echo 'lcc ' l:cc
    if 'l' == a:ld
"	let l:chcc = 255 - l:cc
"	echo 'lchcc minus ' l:chcc
"	let l:chcc = l:chcc * a:corr
"	echo 'lchcc mul ' l:chcc
"	let l:chcc = l:chcc + l:cc
"	echo 'lchcc plus ' l:chcc
"	let l:chcc = float2nr(l:chcc)
"	echo 'lchcc 2 nr ' l:chcc
	let l:chcc = float2nr(((255 - l:cc) * l:corr) + l:cc)
	echo 'chcc for l ' l:chcc
    elseif 'd' == a:ld
"	let l:chcc = float2nr(l:cc * l:corr)
	let l:chcc = float2nr(((255 - l:cc) * l:corr) - l:cc)
	echo 'chcc for d ' l:chcc
    endif
    if 255 > l:chcc
	let l:chcc = s:Dec2Hex(l:chcc)
	if 2 != len(l:chcc)
	    let l:chcc = 0..l:chcc
	endif
	let l:hexcolo = l:hexcolo .. l:chcc
	echo "lhexcolo g 255 " l:hexcolo
    else
	let l:hexcolo = l:hexcolo .. l:cc
	echo "lhexcolo l 255 " l:hexcolo
    endif
    let l:idx += 2
endwhile
return l:hexcolo
...
"		  call mkdir(l:wrtdir .. '/Colo2CSS', '', '0o755')
"		endif
